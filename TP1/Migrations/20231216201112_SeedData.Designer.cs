...
namespace TP1.Migrations
{
    ...
    [Migration("20231216201112_SeedData")]
            ...
            modelBuilder.Entity("TP1.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2023, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FreeDelivery = true,
                            GenreID = "5",
            ...
            modelBuilder.Entity("TP1.Models.Genre", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GenreID = "1",
                            GenreString = "Ficção Científica"
                        },
                        new
                        {
                            GenreID = "2",
                            GenreString = "Fantasia"
                        },
                        new
                        {
                            GenreID = "3",
                            GenreString = "Mistério"
                        },
                        new
                        {
                            GenreID = "4",
                            GenreString = "Suspense"
                        },
                        new
                        {
                            GenreID = "5",
                        ...
                        {
                            GenreID = "6",
                            GenreString = "Ficção Histórica"
                        },
                        new
                        {
                            GenreID = "7",
                            GenreString = "Aventura"
                        },
                        new
                        {
                            GenreID = "8",
                        ...
                        {
                            GenreID = "9",
                            GenreString = "Não Ficção"
                        },
                        new
                        {
                            GenreID = "10",
                            GenreString = "Biografia"
                        });
                });
